appConfig = { //eslint-disable-line
  ...
  // logo_location: 'assets/img/logo/banana.png',
  ...
  fields_to_display:['director_info.director_name', 'cast_info.0.actor_name', 'num_critic_for_reviews'],
  field_display_labels: {
    'director_info.director_name': 'Director',
    'cast_info.0.actor_name': 'Lead actor',
  ...
  typeahead_fields: ['movie_title', 'director_info.director_name'],
